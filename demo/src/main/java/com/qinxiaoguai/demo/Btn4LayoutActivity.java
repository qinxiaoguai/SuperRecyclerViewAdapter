 ...
 */
public class Btn4LayoutActivity extends AppCompatActivity {
    ...
    private void initView() {
        ...
        mAdapter = new SuperRecyclerAdapter<String>(this, mList) {
                ...
                holder//
                    ...
                    .setOnItemClickListenner(new View.OnClickListener() {
                        @Override public void onClick(View v) {
                            Toast.makeText(Btn4LayoutActivity.this, "item被点击", Toast.LENGTH_SHORT)
                                .show();
                        }
                    });
            }
            ...
            @Override public int getLayoutAsViewType(String s, int position) {
                return R.layout.recycler_item_btn4;
            }
        };
